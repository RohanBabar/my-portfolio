...
const textArray = ["Software Developer", "C++ & Python Programmer", "Full Stack Web Developer","AWS & DevOps Practitioner","Open Source Enthusiast"];
...
document.getElementById('hireMeBtn').addEventListener('click', function () {
  ...
  window.location.href = "mailto:rohanbabar190903@gmail.com?subject=Interested%20in%20Hiring%20You";
  setTimeout(() => {
    alert("If your email client didn't open, please mail me directly at rohanbabar190903@gmail.com");
  }, 2000);
